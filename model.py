...
class ModelIdol(ModelBase):
    ...
    def _build_inputs(self):
        ...
        """
        # Images 32x32x3
        tf_images = tf.placeholder(tf.float32, [None, 32, 32, 3], name='images')        # rm 1 with 3
        # Labels: [0, 1, 6, 20, ...]
    ...
    def _build_main_network(self, images, conv_2_dropout):
        ...
        # First BLock:
        # Layer 1: Convolution.
        shape = (self.h.conv_1_size, self.h.conv_1_size, 3, self.h.conv_1_nb)               # rm 1 with 3
    ...
    def _build_loss(self, caps2, one_hot_labels, labels, decoded, images):
        ...
        capsules_length = tf.sqrt(tf.reduce_sum(tf.square(caps2), axis=2, keep_dims=True)) # rm 1 with 2
    ...
    def predict_image(self, images, labels, batch_size = 1): # To evaluate a single image passed on to this
        """
            ...
            *input: **
                *image: Image to test and predict
